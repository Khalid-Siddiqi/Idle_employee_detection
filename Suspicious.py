...
frame_total = 2000
i = 0
a = 2159 # Start from 848 forcefully

all_data = []

# Define output path for cropped images
output_path_dir = r'C:\Users\freed\Downloads\yolo11-suspicious-action-main\yolo11-suspicious-action-main\images1'
...
while cap.isOpened():
    ...
    pa = r'C:\Users\freed\Downloads\yolo11-suspicious-action-main\yolo11-suspicious-action-main\images'
...
csv_file_path = r'C:\Users\freed\Downloads\yolo11-suspicious-action-main\yolo11-suspicious-action-main\nkeypoint.csv'
