...
df = pd.read_csv(r'C:\Users\freed\Downloads\yolo11-suspicious-action-main\yolo11-suspicious-action-main\nkeypoint.csv')

dataset_path = r'C:\Users\freed\Downloads\yolo11-suspicious-action-main\yolo11-suspicious-action-main\dataset_path'
